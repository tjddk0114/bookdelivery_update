...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-title v-if="value._links">
        Ordermgmt # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
    </v-card-title >
    <v-card-title v-else>
        Ordermgmt
    </v-card-title >
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="OrderMgmtId" v-model="value.orderMgmtId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            OrderMgmtId :  {{value.orderMgmtId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="ItemName" v-model="value.itemName"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="DeliveryAddress" v-model="value.deliveryAddress"/>
          </div>
          <div class="grey--text ml-4" v-else>
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field label="DeliveryPhoneNumber" v-model="value.deliveryPhoneNumber"/>
          </div>
          <div class="grey--text ml-4" v-else>
            DeliveryPhoneNumber :  {{value.deliveryPhoneNumber }}
          </div>
